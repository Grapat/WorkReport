            ...
            */}
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                ...
                                เซิร์ฟเวอร์เบื้องต้นสำหรับพัฒนา application ด้วย <strong>Node.js</strong>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                ...
                                อัปเดตงาน project fleet card ocr กับพี่เลี้ยง
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                ...
                                รับเกรียติบัตรนักศึกษาผู้มีผลการเรียนดีเด่น
                            </p>
                        </div>
                        ...
                        <div className="item-pictures-container">
                            <div className="item-picture-wrapper">
                                <img src="/pic/13.jpg" className="item-picture" />
                            </div>
                            <div className="item-picture-wrapper">
                                <img src="/pic/12.jpg" className="item-picture" />
                            </div>
                        </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>6 สิงหาคม 2025</strong><br />
                                อัปเดตงาน project fleet card ocr กับพี่เลี้ยง
                            </p>
                        </div>
                    </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>6 สิงหาคม 2025</strong><br />
                                ทำงานย่อย full calendar แก้ full calendar ของพี่เลี้ยงที่ทำไว้
                                ให้สามารถแสดงผลได้อย่างที่พี่เลี้ยงต้องการ โดยใช้ <strong>PHP</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>29 สิงหาคม 2025</strong><br />
                                กินเลี้ยงแผนก
                            </p>
                        </div>
                        ...
                        <div className="item-pictures-container">
                            <div className="item-picture-wrapper">
                                <img src="/pic/25884_0.jpg" className="item-picture" />
                            </div>
                            <div className="item-picture-wrapper">
                                <img src="/pic/25885_0.jpg" className="item-picture" />
                            </div>
                        </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>3 กันยายน 2025</strong><br />
                        ...
                        <div className="item-pictures-container">
                            <div className="item-picture-wrapper">
                                <img src="/pic/2.jpg" className="item-picture" />
                            </div>
                            <div className="item-picture-wrapper">
                                <img src="/pic/4.jpg" className="item-picture" />
                            </div>
                        </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>17 กันยายน 2025</strong><br />
                                อัปเดตงาน project fleet card ocr กับพี่เลี้ยง
                            </p>
                        </div>
                    </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>2 ตุลาคม 2025</strong><br />
                                ทำงานย่อย watertele ทำ script ดึงข้อมูลจากเว็บไซต์
                                มาลงใน google sheet ด้วย <strong>google app script</strong>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>16 ตุลาคม 2025</strong><br />
                                นิเทศสหกิจ ครั้งที่ 1
                            </p>
                        </div>
                    </div>
                ...
                <div className="gallery-work-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-detail-box">
                            <p className="item-date-detail">
                                <strong>1 พฤศจิกายน 2025</strong><br />
                                นำเสนอผลงานสหกิจ
                            </p>
                        </div>
                    </div>
